...
2. Get a cluster IP. Teams has a spreadsheet of IPs. Pick one and add your initials.

3. Access your server over WebSSH (https://webssh.bret.today)

   - username: k8s  |  password: training

4. Your cluster has three nodes. Test ssh from node1 to node2/3 with `ssh node2` etc.
